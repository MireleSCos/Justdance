...
void IdentificadorObjetoIndicador::pintarVerde(){
...
void IdentificadorObjetoIndicador::pintarAzul(int array[], int passosMus[], int sequencia){
    //Zerar campos 
	for (i = 0; i < 9; i++) {
		campos[i] = 0;
	}
...
void IdentificadorObjetoIndicador::filtrarFrameVermelho(){
...
void IdentificadorObjetoIndicador::buscarObjetoVermelho(int thresholds[]){
    // Zera thresholds
	for (i = 0; i < 9; i++) {
		thresholds[i] = 0;
	}
